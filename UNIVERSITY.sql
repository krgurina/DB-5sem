...
CREATE TABLE FACULTY
  (
   FACULTY      CHAR(30)      NOT NULL primary key,
...
CREATE TABLE PULPIT
(
 PULPIT       CHAR(30)      NOT NULL primary key,
 PULPIT_NAME  VARCHAR2(160),
 FACULTY      CHAR(30)      NOT NULL  references FACULTY(FACULTY)
 );
...
(
  ...
  AUDITORIUM_TYPENAME  varchar2(80) constraint AUDITORIUM_TYPENAME_NOT_NULL not null
);
